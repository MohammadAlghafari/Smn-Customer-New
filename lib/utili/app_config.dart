...
class Colors {
  ...
  Color mainColor(double opacity) {
    try {
      return Color(int.parse(Provider.of<SettingViewModel>(_context!,listen: false).setting.mainColor.replaceAll("#", "0xFF"))).withOpacity(opacity);
    } catch (e) {
  ...
  Color accentColor(double opacity) {
    try {
      return Color(int.parse(Provider.of<SettingViewModel>(_context!,listen: false).setting.accentColor.replaceAll("#", "0xFF"))).withOpacity(opacity);
    } catch (e) {
      return Color(0xFFCCCCCC).withOpacity(opacity);
    }
  }
