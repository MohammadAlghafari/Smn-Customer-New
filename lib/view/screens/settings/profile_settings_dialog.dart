                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: getInputDecoration(
                              ...
                              labelText: _trans.email_address),
                          initialValue: widget.user.email,
                          validator: (input) => !input!.contains('@')
                              ? _trans.not_a_valid_email
                              : null,
                        ...
                        /* new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(hintText: '+136 269 9765', labelText: _trans.phone),
                          initialValue: widget.user.phone,
                          validator: (input) => input.trim().length < 3 ? _trans.not_a_valid_phone : null,
                        ...
                        TextFormField(
                          ...
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(
                              hintText: _trans.your_address,
                              labelText: _trans.address),
                          initialValue: widget.user.address,
                          validator: (input) => input!.trim().length < 3
                              ? _trans.not_a_valid_address
                              : null,
                        ...
                        TextFormField(
                          ...
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(
                              hintText: _trans.your_biography,
                              labelText: _trans.about),
                          initialValue: widget.user.bio,
                          validator: (input) => input!.trim().length < 3
                              ? _trans.not_a_valid_biography
                              : null,
