...
class FavoriteListItemWidget extends StatelessWidget {
  ...
  FavoriteListItemWidget({Key? key, required this.heroTag, required this.favorite}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('FoodDetailsScreen', arguments: favorite.food);
      },
      child: Container(
