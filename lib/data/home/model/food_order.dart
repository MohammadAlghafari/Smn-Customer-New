...
class FoodOrder {
  ...
  Food food;
  DateTime dateTime;
  FoodOrder({required this.id,required this.dateTime,required this.extras,required this.food,required this.price,required this.quantity});
  ...
  factory FoodOrder.fromJSON(Map<String, dynamic> jsonMap) {
    ...
    dateTime : jsonMap['updated_at']==null?DateTime.now():DateTime.parse(jsonMap['updated_at']),
